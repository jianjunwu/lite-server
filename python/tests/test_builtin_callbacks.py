...
class TestJsonSchemaValidator:
    ...
    def test_output_skipped_in_stream_mode(self):
        ...
        v.on_response(ctx)  # no raise — stream chunks not validated
    ...
    def test_string_schema_validates_string_request(self):
        ...
        v.on_request(_ctx(request="hello"))  # valid string passes
