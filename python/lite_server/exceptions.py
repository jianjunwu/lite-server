...
class BadRequestError(HTTPException):
    ...
    def __init__(self, detail: str, error_type: str = "invalid_request_error",
                 code: str | None = None, param: str | None = None,
                 headers: dict[str, str] | None = None):
        super().__init__(400, detail, error_type, code=code, param=param, headers=headers)
...
class UnauthorizedError(HTTPException):
    ...
    def __init__(self, detail: str, error_type: str = "authentication_error",
                 code: str | None = None, param: str | None = None,
                 headers: dict[str, str] | None = None):
        super().__init__(401, detail, error_type, code=code, param=param, headers=headers)
...
class ForbiddenError(HTTPException):
    ...
    def __init__(self, detail: str, error_type: str = "permission_denied_error",
                 code: str | None = None, param: str | None = None,
                 headers: dict[str, str] | None = None):
        super().__init__(403, detail, error_type, code=code, param=param, headers=headers)
...
class NotFoundError(HTTPException):
    ...
    def __init__(self, detail: str, error_type: str = "not_found_error",
                 code: str | None = None, param: str | None = None,
                 headers: dict[str, str] | None = None):
        super().__init__(404, detail, error_type, code=code, param=param, headers=headers)
...
class InternalServerError(HTTPException):
    ...
    def __init__(
        ...
        super().__init__(500, detail, error_type, code=code, param=param, headers=headers)
...
class ServiceUnavailableError(HTTPException):
    ...
    def __init__(
        ...
        super().__init__(503, detail, error_type, code=code, param=param, headers=headers)
